  ...
  return (
    <>
      ...
      <div className="h-screen flex flex-col">
        <div className="border-b-[1px] border-[#24282f] w-full h-10 items-center flex justify-between px-2 shrink-0">
        ...
        <div className="border-t-[1px] border-[#24282f] w-full flex justify-around h-10 items-center shrink-0 grow-0">
